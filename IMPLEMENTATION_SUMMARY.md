...
4. **Auto-Navigation**
   - App starts with no default data
   - Automatically navigates to individual calendar view
   - Data must be created or imported before absence editing
...
- No demo data is injected on startup
- Auto-navigation behavior remains handled by router state
...
- Lines 887-902: (removed) demo data initialization
...
- [ ] Dropdown shows firefighters after manual creation/import
...
### Data Export
- [ ] Export JSON includes configured data and any created absences
...
2. No sample data is provided on first load
...
3. Clean startup state without seeded data
